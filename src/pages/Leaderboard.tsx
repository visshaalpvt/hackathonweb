...
import { Medal, Search, Crown, TrendingUp, TrendingDown, Minus } from 'lucide-react';
...
const mockLeaderboard: LeaderboardEntry[] = [
    { rank: 1, name: "Sarah Connor", avatar: "SC", points: 2450, change: 'up', department: "CSE" },
    { rank: 2, name: "Alex Murphy", avatar: "AM", points: 2380, change: 'same', department: "AIML" },
    { rank: 3, name: "John Wick", avatar: "JW", points: 2100, change: 'up', department: "IT" },
    { rank: 4, name: "Ellen Ripley", avatar: "ER", points: 1950, change: 'down', department: "CSE" },
    { rank: 5, name: "Tony Stark", avatar: "TS", points: 1890, change: 'up', department: "MECH" },
    { rank: 6, name: "Bruce Wayne", avatar: "BW", points: 1750, change: 'same', department: "CSE" },
    { rank: 7, name: "Peter Parker", avatar: "PP", points: 1600, change: 'down', department: "IT" },
    { rank: 8, name: "Clark Kent", avatar: "CK", points: 1550, change: 'same', department: "AIML" },
    { rank: 9, name: "Diana Prince", avatar: "DP", points: 1400, change: 'up', department: "CSE" },
    { rank: 10, name: "Natasha Romanoff", avatar: "NR", points: 1350, change: 'same', department: "IT" },
];

export default function Leaderboard() {
    const [searchQuery, setSearchQuery] = useState("");

    const filteredData = mockLeaderboard.filter(user =>
        user.name.toLowerCase().includes(searchQuery.toLowerCase())
    );

    const getRankIcon = (rank: number) => {
        switch (rank) {
            case 1: return <Crown className="w-6 h-6 text-yellow-500 fill-yellow-100 animate-pulse" />;
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            {/* Top 3 Cards for Visual Appeal */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
                {[mockLeaderboard[1], mockLeaderboard[0], mockLeaderboard[2]].map((user) => (
